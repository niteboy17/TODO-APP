...
import EmaptyState from "@/components/EmptyState";
...
export default function Index() {
  ...
  const [editingId, setEditingId] = useState<Id<"todos"> | null>(null);  const [editText, setEditText] = useState<string>("");

  const homeStyles = createHomeStyles(colors);

  const todos = useQuery(api.todos.getTodos);
  const togggleTodo = useMutation(api.todos.toggleTodo);
      ...
      <View style={homeStyles.todoItemWrapper}>
        ...
        >
          ...
          >
            ...
            >
              {item.isCompleted && <Ionicons name="checkmark" size={18} color="#ffffffff" />}
            </LinearGradient>
    ...
    <LinearGradient colors={colors.gradients.background} style={homeStyles.container}>
      ...
      >
        <FlatList
          ...
          ListEmptyComponent={<EmaptyState />}
